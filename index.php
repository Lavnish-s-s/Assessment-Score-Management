...
<body class="light">
    ...
    <nav class="navbar navbar-expand-lg">
			<a class="navbar-brand" href="index.php">Academy Dashboard</a>
    ...
    <div class="jumbotron text-center">
		...
		<img src="logo.jpeg" alt="Logo" class="logo" height="270" width="270">
    </div>
	</header>
	<section style="margin-top: 40px;">
		...
		<p style="font-size: 25px; font-family: Comic Sans MS;"><b><span style="color: cadetblue;">Automated</span> Student Score Management with Grade calculation</b></p>
	</section>
	</body>
</html>